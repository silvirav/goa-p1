...
int main()
{
    ...
    //Shader *shader = new IntersectionShader (intersectionColor, bgColor); // ex2
    //Shader *shader = new DepthShader (intersectionColor, bgColor);        // ex3
    Shader* shader = new NormalShader(intersectionColor, bgColor);          // ex4
    //Shader* shader = new DirectShader(intersectionColor, bgColor);        // ex5
